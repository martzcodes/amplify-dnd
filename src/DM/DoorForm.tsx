...
function DoorForm({ door, upsertDoor, deleteDoor }: { door: DoorProps; upsertDoor: any; deleteDoor: any; }) {
    ...
    <div className="py-1">
      ...
      <div className="flex bg-gray-50">
        <div className="flex-1">
          {door.id ? `${door.locked ? 'LOCKED' : door.open ? 'OPEN' : 'CLOSED'} ${door.northSouth ? 'NS' : 'EW'} Door @ (${door.origin.x},${door.origin.y})` : ''}
        </div>
        <div className="flex-1">
          {door.id ? (
            <button
