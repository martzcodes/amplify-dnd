...
function CharacterForm({ character, upsertCharacter, deleteCharacter }: { character: CharacterProps; upsertCharacter: any; deleteCharacter: any; }) {
  ...
  return (
    <div className="py-1">
      ...
      <div className={`flex bg-gray-50 ${character.id ? `${character.color} text-white` : ''}`}>
        <div className={`flex-1`}>{character.id ? `${character.name}` : ""}</div>
