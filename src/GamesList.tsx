          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {games.map((game) => (
              <tr key={game.id}>
                ...
                <td className="px-2 py-4 whitespace-nowrap">{game.name}</td>
                <td className="px-2 py-4 whitespace-nowrap">{game.type}</td>
